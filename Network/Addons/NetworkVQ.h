...
public:
	...
	void NewCodeVector(vector<float>& oldCodeVector, vector<float>& inputVector);
	void NewCodeVectorVector(vector<float>& oldCodeVector, vector<float>& inputVector, vector<float>& eta);
