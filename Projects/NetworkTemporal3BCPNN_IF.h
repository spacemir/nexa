...
class NetworkTemporal3BCPNN_IF : public Network
{
public:
	// setters
...
private:
	...
	// Plasticity
	ProjectionModifierHebbSimple* m_lin;
	...
	Meter* m_inputMeter,*m_layer1Meter,*m_layer2Meter, *m_activityMeter, *m_activityMeter2;
	// Strengths
